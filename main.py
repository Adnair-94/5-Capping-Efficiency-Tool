...
Version 2 changes:
- Uses an embedded Plotly graph through Qt WebEngine so box/lasso selection behaves
  much closer to the original Shiny/plotly app.
- Reworks the GUI into split panes and tabs instead of compressing every control
  into one long sidebar.
...
"""
    ...
    def plot_selected_species(self):
        ...
        if WEBENGINE_AVAILABLE:
            self.plot_view.setHtml(self._plotly_html(eic, species, rt_window=rt_window))
        else:
